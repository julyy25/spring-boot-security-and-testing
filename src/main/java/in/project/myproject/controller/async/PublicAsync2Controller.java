...
import in.project.myproject.service.async.AsyncService2;
...
@RequestMapping("/public/async2/")
public class PublicAsync2Controller {
    private final AsyncService2 asyncService2;

    @GetMapping("/greeting1")
    public CompletableFuture<String> asyncGreeting1() {
        CompletableFuture<String> part1 = asyncService2.getMessagePart1();
        return part1;
    }

    @GetMapping("/greeting2")
    public CompletableFuture<String> asyncGreeting2() {
        CompletableFuture<String> part2 = asyncService2.getMessagePart2();
        return part2;
    }
